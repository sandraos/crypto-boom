...
contract example
{
    ...
    function is_zombie_reaper() public view
        returns(bool)
    {
    ...
    function systemd_pid() public pure
        returns(uint32)
    {
    ...
    function celcius2fahrenheit(int32 celcius) public pure
        returns(int32)
    {
    ...
    function fahrenheit2celcius(int32 fahrenheit) public pure
        returns(int32)
    {
    ...
    function is_power_of_2(uint256 n) public pure
        returns(bool)
    {
        return n != 0 && (n & (n - 1)) == 0;
    }
    ...
    function population_count(uint256 n) public pure
    ...
    function power(uint256 base, uint256 exp) public pure
        returns(uint256)
    {
        return base * *exp;
    }
    ...
    function is_address_zero(address a) public pure
        returns(bool)
    {
        return a == address(0);
    }
    ...
    function byte8reverse(bytes8 input) public pure
        returns(bytes8 out)
    {
    ...
    function get_pid_state(uint64 _pid) private pure
        returns(State)
    {
        uint64 n = 8;
    ...
    function get_pid_state() private view
        returns(uint32)
    {
        return reaped;
    }
    ...
    function run_queue() public pure
        returns(uint16)
    {
        uint16 count = 0;
    ...
    function set_card1(card memory c) public
        returns(card memory previous)
    {
        previous = card1;
        card1 = c;
    }
    ...
    function ace_of_spaces() public pure
        returns(card memory)
    {
    ...
    /// score card
    function score_card(card memory c) public pure
